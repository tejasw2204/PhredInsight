...
Below are examples of the plots generated by the script under different data conditions:

| Type | Screenshot |
| :--- | :--- |
| **Standard Run** | ![Single Sample](Screenshots/example_output_single_sample.png) |
| **High Quality Run** | ![High Quality](Screenshots/example_output_high_quality.png) |
| **Low Quality Run** | ![Low Quality](Screenshots/example_output_low_quality.png) |
## Output
